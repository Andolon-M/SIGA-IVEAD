                                    ...
                                    <div class="">
                                        <div class="shadow-2xl mx-2 my-2 rounded-lg p-2 bg-white  dark:bg-gray-800 ">
                                            ...
                                            <div>
                                                ...
                                                <div class="w-auto">
                                                    <table class="max text-sm text-left text-gray-500 dark:text-gray-400">
                                        ...
                                        <div class="mx-2 my-2 shadow-2xl rounded-lg p-2 dark:bg-gray-800">
                                            ...
                                            @forelse($team->miembros as $miembro) <!--bucle para llenar la lista de miembros-->
                                            <div class="flex items-start justify-start text-sm">
                                                ...
                                                <div class="flex items-center">
                                                    <span>
                                                        {{$miembro->usuario->name ?? null}} {{$miembro->usuario->last_name ?? null}}
                                                        ({{$miembro->usuario->data_users->first()->dni_user ?? null}})
                                                    </span>
                                                    <a @click="$dispatch('quitar_miembro', {id: {{$miembro->id}}})" class="bg-red-800 text-white p-1 m-1 rounded cursor-pointer ml-2">Quitar</a>
                                                </div>
                                                <br>
                                            ...
                                            <div class="mb-6 mx-1">
                                                ...
                                                <div class="relative my-2">
                                                    ...
                                                    <!--campo de busqueda-->
                                                    <input wire:model.live.debounce.700ms="search" type="text" id="table-search-member-team" class="block p-2 pl-10 text-sm text-gray-900 border border-green-300 rounded-lg w-80 bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-green-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Buscar Usuarios">
                                                    <div class="relative overflow-x-auto">
                                                        <table class="max-w-3xl max-h-full text-sm text-left text-gray-500 dark:text-gray-400">
                                                            <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                                                                <tr>
                                                                    <th scope="col" class="px-6 py-3">
                                                                        Nombre
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                                                    ...
                                                                    <td class="px-6 py-4">
                                                                        <a @click="$dispatch('asignar_miembro', {id:{{$user->id}}})" class=" cursor-pointer rounded bg-green-700 dark:bg-gray-900 hover:green-900 text-white dark:border dark:border-green-500 p-1">
                                                                            Asignar
                                                                        </a>
                                                    ...
                                                    @else
                                                    <p class="text-lg text-red-500"> Seleccione un Lider</p>
                                                    @endif
                                                </div>
                                            </div>
