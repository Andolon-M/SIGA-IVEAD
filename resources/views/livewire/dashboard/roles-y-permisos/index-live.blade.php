<div>
    ...
    @livewire('Dashboard.RolesYPermisos.CreateRole')
    @livewire('Dashboard.RolesYPermisos.EditRole')
    ...
    <div class="flex items-center justify-between pb-4 bg-white dark:bg-gray-800 p-1 flex-wrap">
        <div class="flex flex-wrap">
            ...
            <a wire:click="$dispatch('show_modal_create')" class="cursor-pointer sm:w-auto text-white bg-green-700 hover:bg-green-900 dark:bg-gray-800 dark:hover:bg-green-900 border border-green-600 dark:focus:ring-green-800 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-lg text-md px-2 py-2.5 m-1 text-center">
    ...
    <table class="w-full text-sm text-left text-green-800 dark:text-white dark:bg-gray-700 my-4">
        ...
        <tbody>
            @if($roles)
            @foreach($roles as $role) <!-- Bucle para llenar la tabla -->
            <tr @click="$dispatch('show_modal_edit', {id:{{$role->id}}})" class="focus:ring-4 bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-green-100 dark:hover:bg-gray-800 dark:hover:border-green-600">
                ...
                <th scope="row" title="click para ver, editar o eliminar">
                    <a href="#" class="cursor-pointer flex items-center px-1 py-4 text-gray-900 whitespace-nowrap dark:text-white">
                       
                        <div class="pl-3">
                            <div class="flex flex-wrap sm:flex-no-wrap">
                                <div class="text-base font-semibold mr-1.5">{{$role->name ?? null }}</div>
            ...
            @else
            <samp class="text-lg text-red-700"> <strong>No se encontraron Roles</strong></samp>
            @endif
        </tbody>
    </table>
