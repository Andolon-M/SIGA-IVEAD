  ...
  <div class="px-3 py-1  lg:px-5">
    <div class="flex align-middle justify-between">
      ...
      <div class="flex justify-center">
        ...
        <a id="name_ive" href="/" class="flex ml-2 ">
      ...
      <div class="h-16 flex justify-center items-center">
        ...
        <a id="tex_navbar4" href="{{ route('login') }}" class="py-1 px-4 flex h-fit hover:border-2 hover:border-green-200 rounded-xl focus:ring-4 focus:ring-green-700 dark:focus:ring-green-900 text-white hover:text-bg-white">
          <p class="text font-serif">
            Iniciar Sesión
          </p>
        </a>
        ...
        <div class="col">
          ...
          <form method="POST" action="{{ route('logout') }}" class="flex justify-center items-center ">
            ...
            <button onclick="event.preventDefault();
                        this.closest('form').submit(); " data-modal-hide="cerrar_session" class="bg-red-600 hover:bg-red-900 focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 font-medium rounded-lg text-sm text-white inline-flex items-center px-5 py-2.5 text-center mr-2">
              Si. Cerrar Sesión
            </button>
