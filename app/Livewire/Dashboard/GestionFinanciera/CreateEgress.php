...
class CreateEgress extends Component
{
    ...
    public function save()
    {
        ...
        // Puedes emitir un mensaje de éxito o redirigir a otra página
        session()->flash('message', 'Transacción creada con éxito.');
    }
    public function render()
    {
        return view('livewire.dashboard.gestion-financiera.create-egress');
    }
}
